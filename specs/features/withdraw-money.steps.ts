...
defineFeature(feature, (test) => {
    ...
    test('Can not withdraw money from the wallet if there is not enough founds', ({given, when, then}) => {
        let wallet: Wallet;
        ...
        then('I see message "You have not enough money in your wallet."', () => {
            ...
            expect(result.left.message).toBe("You have not enough money in your wallet.")
        });
    });
});
